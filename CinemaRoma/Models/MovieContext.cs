...
namespace CinemaRoma.Models
{
    public partial class MovieContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer("Data Source=banking-sqlserver.database.windows.net;Initial Catalog=CinemaNetwork;User ID=sqlserver;Password=BankingSystem08");
            }
        }
